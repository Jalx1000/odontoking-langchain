...
class Settings:
    ...
    def __init__(self):
        ...
        # Per-request timeout so a stalled OpenAI connection fast-fails and retries within the
        # total budget, instead of hanging until the outer wait_for cancels the whole turn.
